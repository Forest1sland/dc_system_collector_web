        ...
        <div id="bottom">
            <van-button id="button" @click="toPerson">
                <svg t="1667640621636" class="icon" viewBox="0 0 1040 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="2076" width="100" height="100">
                    <path
...
#button {
    background: linear-gradient(-45deg, #ffffff, #2b98ff, #7ed9fb, #7ee5cd);
    /* 背景尺寸 - 原理3 */
